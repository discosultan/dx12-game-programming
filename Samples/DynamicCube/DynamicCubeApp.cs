...
namespace DX12GameProgramming
{
    public class DynamicCubeApp : D3DApp
    {
        ...
        protected override void OnResize()
        {
            ...
            _dynamicCubeMap?.OnResize(ClientWidth, ClientHeight);
        }
        ...
        private void UpdateCubeMapFacePassCBs()
        {
            for (int i = 0; i < 6; i++)
            {
                ...
                cubeFacePassCB.RenderTargetSize = new Vector2(CubeMapSize, CubeMapSize);
                cubeFacePassCB.InvRenderTargetSize = new Vector2(1.0f / CubeMapSize, 1.0f / CubeMapSize);
        ...
        private void BuildRenderItems()
        {
            ...
            boxRitem.PrimitiveType = PrimitiveTopology.TriangleList;
            boxRitem.IndexCount = globeRitem.Geo.DrawArgs["sphere"].IndexCount;
            boxRitem.StartIndexLocation = globeRitem.Geo.DrawArgs["sphere"].StartIndexLocation;
            boxRitem.BaseVertexLocation = globeRitem.Geo.DrawArgs["sphere"].BaseVertexLocation;
